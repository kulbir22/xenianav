...
export default class Leaves extends Component {
  ...
  showLoader = () => {
    ...
    taskOverViewComment(){
      const context=this;
      this.props.navigation.navigate('taskOverViewComment', {data:this.state.MyData, AnotherValue:this.state.AnotherValue});
      this.setState({ slideAnimationDialog: false });
     }
     taskOverViewUpdate(){
      const context=this;
      this.props.navigation.navigate('taskOverViewUpdate', {data:this.state.MyData, AnotherValue:this.state.AnotherValue});
      this.setState({ slideAnimationDialog: false });
     }
     taskOverViewHistory(){
      const context=this;
      this.props.navigation.navigate('taskOverViewHistory', {data:this.state.MyData, AnotherValue:this.state.AnotherValue});
      this.setState({ slideAnimationDialog: false });
     }
    // taskOverViewComment(){
    //   const context=this;
