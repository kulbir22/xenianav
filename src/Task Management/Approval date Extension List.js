...
export default class ApprovalDateExtensionList extends Component {
    ...
    constructor(props){
        ...
        this.props.navigation.setOptions({
          title: 'Approve Date Entension List'
        })
    }
    ...
    approveRejectTaskDateExtension=async()=>{
        ...
        xhr.addEventListener("readystatechange", function() {
            ...
            if(xhr.status === 200) {
                ...
                context.setState({buttonPressed: false, commentError: true, fromTimeStamp: moment().valueOf()})
                context.setState({mandatory:'1'})
                context.setState({Data:[]})
    ...
    render (){
        const {
            approvalStatus,errorCode,apiCode, slideAnimationDialog, buttonPressed, dateError, commentError, loading,
            fromMinDate, fromTime, fromTimeStamp, showFromDatePicker, alloted_date
        } = this.state;
        const context=this;
                        ...
                        >
                            <View style={[{alignItems: 'center', backgroundColor: 'white', borderRadius: 10}, getWidthnHeight(85, 45)]}>
                                ...
                                <View style={{flex: 1, justifyContent: 'space-evenly', alignItems: 'center'}}>
                                    ...
                                    <View style={[{flexDirection:'row',justifyContent:'space-between',paddingLeft:0,paddingRight:0}, getWidthnHeight(70)]}>
                                            ...
                                            <View style={{alignItems: 'flex-start'}}>
                                                ...
                                                >
                                                    <View 
                                                        ...
                                                        }, getWidthnHeight(32, 6)]}>
                                                        <Text style={[{color: '#000000', fontSize: (fontSizeH4().fontSize + 2)}]}>{this.state.modal_required_date}</Text>
                                                    </View>
                                                </TouchableOpacity>
                                                <View style={styles.forDate}>
                                                    <Text style={[{fontSize: (fontSizeH4().fontSize - 4), color: 'rgb(19,111,232)', fontWeight: 'bold', textAlign: 'center'}, styles.boldFont]}>Previous Date</Text>
                                                </View>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{alignItems: 'center'}}>
                                            ...
                                            /> */}
                                            <View style={[{borderColor: 'red', borderWidth: 0}, getWidthnHeight(33, 6)]}>
                                                <TouchableOpacity 
                                                ...
                                                >
                                                    <View 
                                                        style={[{
                                                            alignItems: 'center', justifyContent: 'center', borderRadius: 5, 
                                                            borderColor: '#C4C4C4', borderWidth: 1
                                                        }, getWidthnHeight(33, 6)]}>
                                                        <Text style={[{color: '#000000', fontSize: (fontSizeH4().fontSize + 2)}]}>{alloted_date || 'Select Date'}</Text>
                                                    </View>
                                                </TouchableOpacity>
                                                {(showFromDatePicker) && (
                                                    <DateTimePicker 
                                                        ...
                                                        onDateChange={(event, newDate) => {
                                                            ...
                                                            this.setState({
                                                                alloted_date: moment(newDate).format("YYYY-MM-DD"), fromTimeStamp
                                                            }, () => {});
                                                            Keyboard.dismiss();
                                                        }} 
                                                    />
