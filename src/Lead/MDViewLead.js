...
class App extends Component {
  constructor(props) {
    ...
    Approve_lead=async()=>{
        ...
        const {screen, view_lead} = this.props.route.params;
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={{marginTop: 10, alignItems: 'center'}}>
                            ...
                            <TouchableOpacity style={[{borderColor: 'green', borderWidth: 0, marginHorizontal: 10, marginTop: 10, alignItems: 'center'}, getWidthnHeight(50)]} onPress={() => {
                                ...
                                this.props.navigation.navigate('LeadComments',{Comment:Comment,name:name, screen: this.props.route.name, leadCode: ViewLead.lead_code})
                                //console.log("TOUCHED")
                            }}>
