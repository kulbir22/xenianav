...
import {getWidthnHeight, ModalAlert, CommonModal, IOS_StatusBar, WaveHeader, getMarginTop, Spinner, getMarginLeft} from '../NewComponents/common';
...
const LONGITUDE_DELTA = 0.00421;
    ...
    class App extends React.Component {
        ...
        componentDidMount() {
            ...
            this._unsubscribe = addListener("focus", async() => {
                    ...
                    if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                        ...
                        .then(data => {
                            ...
                            Geolocation.getCurrentPosition(
                                ...
                                { enableHighAccuracy: true, timeout: 2000000, maximumAge: 1000000 },
                            );
                        }).catch(err => {
        ...
        async markAttendance(latitude, longitude){
            ...
            ,
            {
                ...
                this.setState({
                    file: undefined, comment: 'Check-Out', fileError: true, Lat_LongError: true,
        ...
        render() {
            ...
            return (
                <View>
                <KeyboardAvoidingView behavior="position" style={styles.container} keyboardShouldPersistTaps={'never'}>
