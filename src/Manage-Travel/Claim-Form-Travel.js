...
import {
    StyleSheet, Text, TouchableOpacity, Keyboard,
...
import {
    ...
    IOS_StatusBar, statusBarGradient, DateTimePicker, getMarginVertical, getMarginBottom, DocumentsModal} from '../KulbirComponents/common';
...
export default class Claim_Form_Travel extends React.Component {
    ...
    checkErrorsInStayForm(){
        ...
        if(chechError){
            ...
            const date2 = moment(stayDate2, "DD-MM-YYYY");
            const days = date2.diff(date1, 'days');
            const checkDate = moment(stayDate).isSame(stayDate2);
...
render() {
    ...
    const {
        ...
        toState, toStateID, toStateError, fromStateArray, toStateArray, travelTimeStamp, travelMinDate, showTravelDatePicker, travelMaxDate,
