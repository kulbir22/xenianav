...
export default class View_Travel extends React.Component {
    ...
    async callAPI(){
        ...
        console.log("USER ID: ", userObj.success.user.id, status.toLowerCase(), moment(paidDate).format('YYYY-MM-DD'), remarks, utrNumber);
        axios.post(`${baseURL}/travel/paid-imprest`,
        {
            ...
            travel_id: this.props.route.params.data.id
        },
        {
            headers: {
    ...
    render() {
        const {color, animateClimber, climberFullHeight, status, statusError, utrNumber, utrError,
            ...
            fromDate, fromMinDate, fromTime, fromTimeStamp, showFromDatePicker
        } = this.state;
        let data = [
            {
                value: 'Paid',
        ...
        console.log("### DATA FLAG: ", this.props.route.params.data.imprest_request)
                ...
                <ScrollView nestedScrollEnabled={true} contentContainerStyle={{alignItems: 'center'}}>
                    ...
                    <View style={[getWidthnHeight(100), {alignItems: 'center'}]}>
                        <View style = {[{flexDirection: 'row', justifyContent: 'space-between'}, getMarginTop(2), getWidthnHeight(95)]}>
                            ...
                            /> */}
                            <View style={[{borderColor: 'red', borderWidth: 0}, getWidthnHeight(92/2, 7)]}>
                                <TouchableOpacity 
